...
void Game::drawBoard()
{
	...
	view->drawBlock (mX1 - BOARD_LINE_WIDTH, mY, BOARD_LINE_WIDTH, mScreenHeight - 1, BLACK);
    view->drawBlock (mX2, mY, BOARD_LINE_WIDTH, mScreenHeight - 1, BLACK);
    view->drawBlock (mX1, mScreenHeight, BLOCK_SIZE * BOARD_WIDTH, BOARD_LINE_WIDTH, BLACK );
...
======================================
*/
void Game::drawScene (float score)
{
	score2 = score;
